    ...
    const fetchData = () => {
        fetch('/panel/fetch')
            ...
            .then(function (data) {
                ...
                setSlicedLabels(generateDates().slice(0, range).reverse())
        ...
        <div
            ...
            <header className="px-5 py-4 border-b border-slate-100 flex items-center">
                ...
                <Tooltip className="ml-2">
                    <div className="text-xs text-center whitespace-nowrap">Refresh every 2 seconds
                    </div>
                </Tooltip>
            </header>
